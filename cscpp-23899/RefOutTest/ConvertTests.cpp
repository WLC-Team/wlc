#include "pch.h"
#include "ConvertTests.h"

using namespace SharpTpCppConverterTests;
...
using namespace StyleCop;
using namespace StyleCop::CSharp;
using namespace System::Collections::Generic;
void ConvertTests::ConvertFile(Platform::String^ code)
{
    auto filePath = Path::Combine(@"G:\Builds\tests\", Path::GetFileNameWithoutExtension(Path::GetRandomFileName()) + ".cs");
    auto streamWriter = ref new StreamWriter(filePath);
    streamWriter::Write(code);
    streamWriter::Close();
    SharpToCppConverter::ConvertFile(filePath, @"G:\Builds\tests\", @"C:\Users\Alexander\Documents\Visual Studio 2012\Projects\App1\App1", @"C:\Program Files (x86)\Windows Kits\8.0\References\CommonConfiguration\Neutral\;C:\Program Files (x86)\Microsoft SDKs\Windows\v8.0\ExtensionSDKs\Microsoft.VCLibs\11.0\References\CommonConfiguration\neutral\");
    File::Delete(filePath);
}

SharpToCppInterpreter ConvertTests::GetInterpreter(Platform::String^ code)
{
    auto filePath = Path::Combine(@"G:\Builds\tests\", Path::GetFileNameWithoutExtension(Path::GetRandomFileName()) + ".cs");
    auto streamWriter = ref new StreamWriter(filePath);
    streamWriter::Write(code);
    streamWriter::Close();
    auto interpreters = SharpToCppConverter::GetCsharpInterpretersFromFiles(new 
    {
        filePath
    }, @"G:\Builds\tests\", @"C:\Users\Alexander\Documents\Visual Studio 2012\Projects\App1\App1", @"C:\Program Files (x86)\Microsoft SDKs\Windows\v8.0\ExtensionSDKs\Microsoft.VCLibs\11.0\References\CommonConfiguration\neutral\;C:\Program Files (x86)\Windows Kits\8.0\References\CommonConfiguration\Neutral\");
    File::Delete(filePath);
    return interpreters::FirstOrDefault();
}

void ConvertTests::ConvertHeaderToCsDummay(Platform::String^ code)
{
    auto filePath = Path::Combine(@"G:\Builds\tests\", Path::GetFileNameWithoutExtension(Path::GetRandomFileName()) + ".h");
    auto streamWriter = ref new StreamWriter(filePath);
    streamWriter::Write(code);
    streamWriter::Close();
...
void ConvertTests::ConvertAppXaml()
{
    this->ConvertFile(@"
...
void ConvertTests::BindableBase()
{
    this->ConvertFile(@"
                using Platform;
                using Windows.UI.Xaml.Data;
...
void ConvertTests::BooleanNegationConverter()
{
    this->ConvertFile(@"
                using Platform;
                using Windows.UI.Xaml.Data;
...
void ConvertTests::BooleanToVisibilityConverter()
{
    this->ConvertFile(@"
                using Platform;
                using Windows.Foundation;
...
void ConvertTests::GroupDetailPage()
{
    this->ConvertFile(@"#pragma include ""Common\LayoutAwarePage.h""
...
void ConvertTests::ItemDetailPage()
{
    this->ConvertFile(@"#pragma include ""Common\LayoutAwarePage.h""
...
void ConvertTests::RichTextColumns()
{
    this->ConvertFile(@"#pragma include <collection.h>
...
void ConvertTests::SuspensionManager()
{
    this->ConvertFile(@"
...
void ConvertTests::ConvertClassDeclaration()
{
    this->ConvertFile(@"
                namespace App1
                {
...
void ConvertTests::ConvertCppHeaderFileSuspensionManager()
{
...
void ConvertTests::ConvertCppHeaderFileGroupDetailPageGenHeader()
{
    this->ConvertHeaderToCsDummay(@"
                #pragma once
                //------------------------------------------------------------------------------
...
void ConvertTests::ConvertCppHeaderFileLayoutAwarePage()
{
    this->ConvertHeaderToCsDummay(@"
                #pragma once
...
void ConvertTests::ConvertCppHeaderFileSampleDataSource()
{
    this->ConvertHeaderToCsDummay(@"//
                // SampleDataSource.h
...
void ConvertTests::PropertyFounderRegex1()
{
    auto cpp = @"
			static property Windows::Foundation::Collections::IMap<Platform::String^, Platform::Object^>^ SessionState
			{
            ...
            static int Get();
            ";
    auto match = CxxHeaderToCSharpDummyInterpreter::PropertyFounder::Match(cpp);
    Assert::IsTrue(match::Success);
}

void ConvertTests::PropertyFounderRegex2()
{
    auto cpp = @"
			property Windows::Foundation::Collections::IObservableMap<Platform::String^, Platform::Object^>^ DefaultViewModel
			{
...
void ConvertTests::MethodFounderRegex1()
{
    auto cpp = @"void ItemsCollectionChanged(Windows::Foundation::Collections::IObservableVector<SampleDataItem^>^ a , Windows::Foundation::Collections::IVectorChangedEventArgs^ );";
    auto match = CxxHeaderToCSharpDummyInterpreter::MethodDeclarationFounder::Match(cpp);
    Assert::IsTrue(match::Success);
}

void ConvertTests::MethodFounderRegex2()
{
    auto cpp = @"void ItemsCollectionChanged(Windows::Foundation::Collections::IObservableVector<SampleDataItem^>^ , Windows::Foundation::Collections::IVectorChangedEventArgs^ );";
    auto match = CxxHeaderToCSharpDummyInterpreter::MethodDeclarationFounder::Match(cpp);
    Assert::IsTrue(match::Success);
}

void ConvertTests::MethodFounderRegex3()
{
    auto cpp = @"		
            [Windows::UI::Xaml::Data::Bindable]
		    public ref class SampleDataGroup sealed : public SampleDataCommon
...
void ConvertTests::MethodParametersFounderRegex1()
{
    auto cpp = @"		
			    void ItemsCollectionChanged(Windows::Foundation::Collections::IObservableVector<SampleDataItem^>^ , Windows::Foundation::Collections::IVectorChangedEventArgs^ );";
    auto match = CxxHeaderToCSharpDummyInterpreter::MethodParametersDeclarationFounder::Match(cpp);
    Assert::IsTrue(match::Success);
}

void ConvertTests::MethodParametersFounderRegex2()
{
    auto cpp = @"		
...
void ConvertTests::TypeResolverTest()
{
    auto len = Stopwatch::StartNew();
    ...
    auto document = interpreter::Document;
    auto namespaceElement = document::DocumentContents::ChildCodeElements::First([=](x)
    {
    });
    auto codeElement = namespaceElement::ChildCodeElements::First([=](x)
    {
    });
    auto methodElement = codeElement::ChildCodeElements::First();
    auto returnElement = (dynamic_cast<Method>(methodElement))::ChildStatements::Skip(1).First();
    Assert::IsNotNull(document);
    auto baseGetHashCodeReturnType = ref new ExpressionReturnTypeResolver(interpreter)::Resolve((dynamic_cast<ExpressionStatement>(returnElement))::Expression).ToList();
    Assert::IsTrue((dynamic_cast<IEnumerable>(baseGetHashCodeReturnType))::GetEnumerator().MoveNext());
}
